// =============================================================================
// RhSensoERP - Módulo ControleAcessoPortaria - Dependency Injection
// =============================================================================
// Arquivo: src/Modules/ControleAcessoPortaria/DependencyInjection.cs
...
using RhSensoERP.Modules.ControleAcessoPortaria.Infrastructure.Persistence;
using RhSensoERP.Modules.ControleAcessoPortaria.Infrastructure.Persistence.Contexts;


namespace RhSensoERP.Modules.ControleAcessoPortaria;

/// <summary>
/// Extensões de DI para o módulo ControleAcessoPortaria.
/// </summary>
public static class DependencyInjection
{
    /// <summary>
    /// Adiciona os serviços do módulo ControleAcessoPortaria ao container de DI.
    /// </summary>
    public static IServiceCollection AddControleAcessoPortariaModule(
        ...
        IConfiguration configuration)
    {
        ...
        services.AddDbContext<ControleAcessoPortariaDbContext>((sp, options) =>
        {
            options.UseSqlServer(connectionString, sqlOptions =>
            {
                sqlOptions.MigrationsAssembly(typeof(ControleAcessoPortariaDbContext).Assembly.FullName);
        ...
        // =====================================================================
        services.AddControleAcessoPortariaRepositories();
    ...
    /// </summary>
    public static IServiceCollection AddControleAcessoPortariaRepositories(this IServiceCollection services)
    {
