// =============================================================================
// RhSensoERP - Módulo SaudeOcupacional - Dependency Injection
// =============================================================================
// Arquivo: src/Modules/SaudeOcupacional/DependencyInjection.cs
...
//using RhSensoERP.Modules.SaudeOcupacional.Core.Entities;
using RhSensoERP.Modules.SaudeOcupacional.Infrastructure.Persistence;
using RhSensoERP.Modules.SaudeOcupacional.Infrastructure.Persistence.Contexts;


namespace RhSensoERP.Modules.SaudeOcupacional;

/// <summary>
/// Extensões de DI para o módulo SaudeOcupacional.
/// </summary>
public static class DependencyInjection
{
    /// <summary>
    /// Adiciona os serviços do módulo SaudeOcupacional ao container de DI.
    /// </summary>
    public static IServiceCollection AddSaudeOcupacionalModule(
        ...
        IConfiguration configuration)
    {
        ...
        services.AddDbContext<SaudeOcupacionalDbContext>((sp, options) =>
        {
            options.UseSqlServer(connectionString, sqlOptions =>
            {
                sqlOptions.MigrationsAssembly(typeof(SaudeOcupacionalDbContext).Assembly.FullName);
        ...
        // =====================================================================
        services.AddSaudeOcupacionalRepositories();
    ...
    /// </summary>
    public static IServiceCollection AddSaudeOcupacionalRepositories(this IServiceCollection services)
    {
