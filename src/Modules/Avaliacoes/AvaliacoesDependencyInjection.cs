// =============================================================================
// RhSensoERP - Módulo Avaliacoes - Dependency Injection
// =============================================================================
// Arquivo: src/Modules/Avaliacoes/DependencyInjection.cs
// Registra DbContext, AutoMapper, Repositórios e MediatR handlers
// =============================================================================
using Microsoft.EntityFrameworkCore;
using Microsoft.Extensions.Configuration;
using Microsoft.Extensions.DependencyInjection;
using RhSensoERP.Modules.Avaliacoes.Infrastructure.Persistence;
using RhSensoERP.Modules.Avaliacoes.Infrastructure.Persistence.Contexts;
using System.Reflection;

namespace RhSensoERP.Modules.Avaliacoes;

/// <summary>
/// Extensões de DI para o módulo Avaliacoes.
/// </summary>
public static class DependencyInjection
{
    /// <summary>
    /// Adiciona os serviços do módulo Avaliacoes ao container de DI.
    /// </summary>
    public static IServiceCollection AddAvaliacoesModule(
        ...
        IConfiguration configuration)
    {
        ...
        services.AddDbContext<AvaliacoesDbContext>((sp, options) =>
        {
            options.UseSqlServer(connectionString, sqlOptions =>
            {
                sqlOptions.MigrationsAssembly(typeof(AvaliacoesDbContext).Assembly.FullName);
        ...
        // =====================================================================
        services.AddAvaliacoesRepositories();
    ...
    /// </summary>
    public static IServiceCollection AddAvaliacoesRepositories(this IServiceCollection services)
    {
