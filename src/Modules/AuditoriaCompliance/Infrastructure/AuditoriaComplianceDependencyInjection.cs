// =============================================================================
// RhSensoERP - Módulo AuditoriaCompliance - Dependency Injection
// =============================================================================
// Arquivo: src/Modules/AuditoriaCompliance/DependencyInjection.cs
// Registra DbContext, AutoMapper, Repositórios e MediatR handlers
// =============================================================================
using Microsoft.EntityFrameworkCore;
using Microsoft.Extensions.Configuration;
using Microsoft.Extensions.DependencyInjection;
using RhSensoERP.Modules.AuditoriaCompliance.Infrastructure.Persistence;
using RhSensoERP.Modules.AuditoriaCompliance.Infrastructure.Persistence.Contexts;
using System.Reflection;

namespace RhSensoERP.Modules.AuditoriaCompliance;

/// <summary>
/// Extensões de DI para o módulo AuditoriaCompliance.
/// </summary>
public static class DependencyInjection
{
    /// <summary>
    /// Adiciona os serviços do módulo AuditoriaCompliance ao container de DI.
    /// </summary>
    public static IServiceCollection AddAuditoriaComplianceModule(
        ...
        IConfiguration configuration)
    {
        ...
        services.AddDbContext<AuditoriaComplianceDbContext>((sp, options) =>
        {
            options.UseSqlServer(connectionString, sqlOptions =>
            {
                sqlOptions.MigrationsAssembly(typeof(AuditoriaComplianceDbContext).Assembly.FullName);
        ...
        // =====================================================================
        services.AddAuditoriaComplianceRepositories();
    ...
    /// </summary>
    public static IServiceCollection AddAuditoriaComplianceRepositories(this IServiceCollection services)
    {
