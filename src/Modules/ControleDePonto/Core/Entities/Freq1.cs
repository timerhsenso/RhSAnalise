...
/// <summary>
/// Ocorrências de frequência (ex.: faltas, justificativas, trocas) por colaborador.
/// </summary>
[Table("freq1")]
[PrimaryKey(nameof(NoMatric), nameof(CdEmpresa), nameof(CdFilial), nameof(DtOcorr), nameof(HhIniOcor), nameof(TpOcorr))]
public class Freq1 : BaseEntity
{
