// <auto-generated>
// ============================================================================
//  RhSensoERP.API.Controllers.DiagnosticsController
//  Controller de diagnóstico completo para pré-implantação e suporte.
//  Endpoints: database, migrations, redis, email, logs, permissions, memory,
//             environment, ping, dns, overview.
// ============================================================================
// </auto-generated>
...
ELSE
    ...
    public async Task<IActionResult> TestRedisAsync()
    {
        ...
        // Usa reflexão para não exigir o pacote se você não quiser referenciar StackExchange.Redis na API.
        try
        {
    ...
    // Uptime cross-platform: tenta PerformanceCounter apenas se disponível; caso contrário usa TickCount64.
    private static string GetUptime()
    {
        try
        {
            // Windows: tenta PerformanceCounter via reflection para não exigir o pacote
