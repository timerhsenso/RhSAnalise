// =============================================================================
// RHSENSOERP GENERATOR v3.3 - ENTITY INFO MODEL
// =============================================================================
...
public class EntityInfo
{
    ...
    // =========================================================================
    // NAVEGAÇÕES / RELACIONAMENTOS (NOVO v3.3)
    // =========================================================================

    /// <summary>
    /// Lista de navegações/relacionamentos da Entity.
    /// </summary>
    public List<NavigationInfo> Navigations { get; set; } = new();

    /// <summary>
    /// Navegações do tipo ManyToOne (HasOne).
    /// Ex: Agencia tem Banco.
    /// </summary>
    public IEnumerable<NavigationInfo> ManyToOneNavigations =>
        Navigations.Where(n => n.RelationshipType == NavigationRelationshipType.ManyToOne);

    /// <summary>
    /// Navegações do tipo OneToMany (HasMany/coleções).
    /// Ex: Banco tem ICollection&lt;Agencia&gt;.
    /// </summary>
    public IEnumerable<NavigationInfo> OneToManyNavigations =>
        Navigations.Where(n => n.RelationshipType == NavigationRelationshipType.OneToMany);

    /// <summary>
    /// Indica se a Entity tem navegações.
    /// </summary>
    public bool HasNavigations => Navigations.Count > 0;

    /// <summary>
    /// Indica se a Entity tem navegações ManyToOne (HasOne).
    /// </summary>
    public bool HasManyToOneNavigations => ManyToOneNavigations.Any();

    /// <summary>
    /// Indica se a Entity tem coleções OneToMany (HasMany).
    /// </summary>
    public bool HasOneToManyNavigations => OneToManyNavigations.Any();
