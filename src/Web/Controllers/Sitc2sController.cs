...
/// <summary>
/// Controller para gerenciamento de Situação de Frequência.
/// Herda toda a funcionalidade CRUD de BaseCrudController.
/// </summary>
[Authorize]
public class Sitc2sController 
    : BaseCrudController<Sitc2Dto, CreateSitc2Request, UpdateSitc2Request, Guid>
{
    // =========================================================================
    ...
    private readonly ISitc2ApiService _sitc2Service;

    // =========================================================================
    // CONSTRUTOR
    // =========================================================================

    public Sitc2sController(
        ISitc2ApiService apiService,
        IUserPermissionsCacheService permissionsCache,
        ILogger<Sitc2sController> logger)
        : base(apiService, permissionsCache, logger)
    {
        _sitc2Service = apiService;
    }
    ...
    public async Task<IActionResult> Index(CancellationToken ct = default)
    {
        ...
        var viewModel = new Sitc2sListViewModel
        {
    ...
    public override async Task<IActionResult> Create([FromBody] CreateSitc2Request dto)
    {
    ...
    [HttpPost]
    [ValidateAntiForgeryToken]
    public async Task<IActionResult> Edit([FromQuery] Guid id, [FromBody] UpdateSitc2Request dto)
    {
    ...
    [HttpPut]
    [ValidateAntiForgeryToken]
    public override async Task<IActionResult> Update(Guid id, [FromBody] UpdateSitc2Request dto)
    {
        if (!await CanEditAsync(CdFuncao))
        {
            return JsonError("Você não tem permissão para alterar registros nesta tela.");
