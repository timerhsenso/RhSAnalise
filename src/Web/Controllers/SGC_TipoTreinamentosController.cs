...
using RhSensoERP.Web.Services.SGC_TipoTreinamentos;
...
/// <summary>
/// Controller para gerenciamento de Tipo Treinamento.
/// Herda toda a funcionalidade CRUD de BaseCrudController.
/// </summary>
[Authorize]
public class SGC_TipoTreinamentosController 
    : BaseCrudController<SGC_TipoTreinamentoDto, CreateSGC_TipoTreinamentoRequest, UpdateSGC_TipoTreinamentoRequest, int>
{
    // =========================================================================
    ...
    private readonly ISGC_TipoTreinamentoApiService _sgc_tipotreinamentoService;

    // =========================================================================
    // CONSTRUTOR
    // =========================================================================

    public SGC_TipoTreinamentosController(
        ISGC_TipoTreinamentoApiService apiService,
        IUserPermissionsCacheService permissionsCache,
        ILogger<SGC_TipoTreinamentosController> logger)
        : base(apiService, permissionsCache, logger)
    {
        _sgc_tipotreinamentoService = apiService;
    }
    ...
    public async Task<IActionResult> Index(CancellationToken ct = default)
    {
        ...
        var viewModel = new SGC_TipoTreinamentosListViewModel
        {
    ...
    public override async Task<IActionResult> Create([FromBody] CreateSGC_TipoTreinamentoRequest dto)
    {
    ...
    [HttpPost]
    [ValidateAntiForgeryToken]
    public async Task<IActionResult> Edit([FromQuery] int id, [FromBody] UpdateSGC_TipoTreinamentoRequest dto)
    {
    ...
    [HttpPut]
    [ValidateAntiForgeryToken]
    public override async Task<IActionResult> Update(int id, [FromBody] UpdateSGC_TipoTreinamentoRequest dto)
    {
        if (!await CanEditAsync(CdFuncao))
        {
            return JsonError("Você não tem permissão para alterar registros nesta tela.");
