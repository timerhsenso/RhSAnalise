...
using RhSensoERP.Web.Services.TpTabelas;
using RhSensoERP.Web.Services.Permissions;

namespace RhSensoERP.Web.Controllers;

/// <summary>
/// Controller para gerenciamento de Tipo de Tabela.
/// Herda toda a funcionalidade CRUD de BaseCrudController.
/// </summary>
[Authorize]
public class TpTabelasController 
    : BaseCrudController<TabTaux1Dto, CreateTabTaux1Request, UpdateTabTaux1Request, string>
{
    // =========================================================================
    ...
    private readonly ITabTaux1ApiService _tabtaux1Service;

    // =========================================================================
    // CONSTRUTOR
    // =========================================================================

    public TpTabelasController(
        ITabTaux1ApiService apiService,
        IUserPermissionsCacheService permissionsCache,
        ILogger<TpTabelasController> logger)
        : base(apiService, permissionsCache, logger)
    {
        _tabtaux1Service = apiService;
    }
    ...
    public async Task<IActionResult> Index(CancellationToken ct = default)
    {
        ...
        var viewModel = new TpTabelasListViewModel
        {
    ...
    public override async Task<IActionResult> Create([FromBody] CreateTabTaux1Request dto)
    {
    ...
    [HttpPost]
    [ValidateAntiForgeryToken]
    public async Task<IActionResult> Edit([FromQuery] string id, [FromBody] UpdateTabTaux1Request dto)
    {
    ...
    [HttpPut]
    [ValidateAntiForgeryToken]
    public override async Task<IActionResult> Update(string id, [FromBody] UpdateTabTaux1Request dto)
    {
        if (!await CanEditAsync(CdFuncao))
        {
            return JsonError("Você não tem permissão para alterar registros nesta tela.");
